# Python module  capable of generate data to fine-tune the CNN used to retrieve the LunarLander coordinates.
#
# Gustavo Ciotto
# Lucas Rath Maia
...
# Randomly initializes a new game
...
# Generates images to train our network to retrieve the ship's coordinates.
def simulate_batch(batch_num):
    ...
    while len(obs_data) < _BATCH_SIZE:
        ...
        for t in range(_TIME_STEPS):
            ...
            # Retrieves images in which the ship is centered
