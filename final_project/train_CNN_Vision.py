# Python module  capable of training a CNN to retrieve the ship's coordinates (x, y and angle)
# using transfer learning and tiny YOLO network. This computing is based on the Tensorflow lib.
#
# Gustavo Ciotto
# Lucas Rath Maia
