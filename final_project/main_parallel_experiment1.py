...
# Python module to find the LunarLander controller's optimal policy by using simulator API to retrieve the ship's coordinates.
#
# Gustavo Ciotto
# Lucas Rath Maia
...
# A simple wrapper for parallel execution
...
# Plots important information about each generation
...
if __name__ == "__main__":
    ...
    # Reinforcement Learning gamma parameter.
    gamma = 1.0
    ...
    # Chooses to load from persistent data or to compute everything    
    if load:
    ...
    # Plots a random simulation with random weights    
